...
export interface DB {
  ...
  "_timescaledb_catalog.chunk_rewrite": _TimescaledbCatalogChunkRewrite;
  ...
  "_timescaledb_catalog.continuous_aggs_materialization_ranges": _TimescaledbCatalogContinuousAggsMaterializationRanges;
